...
from . import views 
from .views import UserLoginAPIView,my_question,save_contact_message,hsbc_questions,techm_questions
...
urlpatterns = [
    ...
    path('techmquestion/', techm_questions, name='techmquestion'),
