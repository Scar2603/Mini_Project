        ...
        <>
            ...
            <div style={{ backgroundImage: 'url("/Hero_bg.png")' }}>
                <div style={styles.container}>
                    ...
                    <p style={{ ...styles.p, ...styles.pLargeMargin }}>Tata Consultancy Services Limited</p>
                    ...
                    <strong style={styles.sectionHeading}>It provides various services:</strong>
                    <ul style={styles.ul}>
                    ...
                    <ul style={styles.ul}>
                        ...
                        <ServiceItem><strong style={{fontSize : "px"}}>Roles Offered:</strong>
                            <ul>
                        ...
                        <ServiceItem><strong style={{fontSize : "18px"}}>Eligibility criteria:</strong>
                            <ul>
                        ...
                        <ServiceItem><strong style={{fontSize : "18px"}}>Rounds:</strong>
                            <ul> {/* No additional styles applied */}
                                <li>Four Rounds are conducted in the following manner
                                    <ul style={styles.nestedList}>
                                        <li>1. Online Aptitude Test:
                                            <ul style={styles.nestedList}>
                                ...
                                <li style={{ marginTop: '10px' }}> -The shortlisted students based on their scores get a chance to uplift his/her role from Ninja to Digital.</li>
                    ...
                    <ul style={styles.ul}>
                        <ServiceItem>The topics on which the <strong>TCS Aptitude syllabus</strong> is based on are:
                            <ul style={styles.nestedList}>
                                <ServiceItem>Number System
                                    <ul style={styles.nestedList}>
                                        <li> -Divisibility</li>
                                        <li> -Decimal Fractions and Numbers</li>
                                        <li> -Number System and LCM & HCF</li>
                                        <li> -For a detailed explanation, watch this video: <a href="https://www.youtube.com/live/sVNn6Ptbx6A?si=_S06o-pxk0atFIVC" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                    </ul>
                                </ServiceItem>
                                <ServiceItem>Mensuration
                                    <ul style={styles.nestedList}>
                                        ...
                                        <li> -For a detailed explanation, watch this video: <a href="https://youtu.be/KA3aKKAJbNs?si=sbhqU4D14Zu9ieKT" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                    </ul>
                                </ServiceItem>
                                <ServiceItem>Arithmetic Ability
                                    <ul style={styles.nestedList}>
                                        <li> -Ages</li>
                                        <li> -Averages</li>
                                        <li> -Equations</li>
                                        ...
                                        <li> -Time and Work</li>
                                        <li> -For a detailed explanation, watch this video: <a href="https://youtu.be/S-Ji7aayH3A?si=uUPRpVH0AKjc9HGh" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                    </ul>
                                </ServiceItem>
                                <ServiceItem>Elementary Statistics
                                    <ul style={styles.nestedList}>
                                        <li> -Mean, Median, Mode, Standard Deviation, and Variance</li>
                                        <li> -For a detailed explanation, watch this video: <a href="https://www.youtube.com/live/rIiRZl01TPk?si=G1PEfIPLUBN9LkMq" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                    </ul>
                                </ServiceItem>
                                <ServiceItem>Simplifications & Approximations
                                    <ul style={styles.nestedList}>
                                        <li> -Simple Arithmetic Calculations</li>
                                        <li> -For a detailed explanation, watch this video: <a href="https://youtu.be/ZuMJFleXmiw?si=4rgfhZ_HMhj_DBvl" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                    </ul>
                                </ServiceItem>
                            </ul>
                        </ServiceItem>
                        <ServiceItem>The topics on which the <strong>TCS Verbal Ability syllabus</strong> is based on are:
                            <ul style={styles.nestedList}>
                                <ServiceItem>English Grammar
                                    <ul style={styles.nestedList}>
                                        <li> -Spelling</li>
                                        <li> -Grammar</li>
                                        ...
                                        <li> -For a detailed explanation, watch this video: <a href="https://www.youtube.com/live/ro69GD4D93Q?si=4iMMB5D321jpWtib" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                    </ul>
                                </ServiceItem>
                                <ServiceItem>Reading Comprehension
                                    <ul style={styles.nestedList}>
                                        <li> -Cloze Test</li>
                        ...
                        <ServiceItem>Main topics are:
                            <ul style={styles.nestedList}>
                                <li> -Work & Time : <a href="https://youtu.be/KE7tQf9spPg?si=4tTJD1tosouauKUM" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                <li> -Speed Distance : <a href="https://youtu.be/Qt_js6M1nP4?si=e0aqJdqcOXn3AhY9" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                <li> -Ratio Proportion : <a href="https://youtu.be/jfoJBivWlnQ?si=DxJ1jX-Ph7vLlYGy" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                <li> -Ages : <a href="https://youtu.be/NtPHWGFE9o8?si=YJoR2mQeYU0FVO8o" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                <li> -Clock : <a href="https://youtu.be/edEvlh0tqzk?si=k6DDCuUTHywqBvnI" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                <li> -Permutation : <a href="https://youtu.be/ETiRE7N7pEI?si=XHGoR7647s6KeAbl" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
                                <li> -Logical Reasoning (encoding decoding) : <a href="https://youtu.be/QsD0JiNBDeQ?si=UA0oiPuF0tTbqRKa" target="_blank" style={{ color: 'red' }}>Watch Video</a></li>
