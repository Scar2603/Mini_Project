...
const ServiceItem = ({ children }) => {
    ...
    const hasPadding = !childString.startsWith('60%') && !childString.includes('No related branches like AIML, etc.');
    const isSpecialCase = childString.includes('No related branches like AIML, etc.');
            ...
            <div style={styles.container}>
                <div style={styles.contentContainer}>
                    <div style={{ padding: '20px' }}>
                        ...
                        <h3 style={{ fontWeight: 'bold', fontSize: '24px' }}>HSBC Campus Recruitment Process</h3> {/* Updated heading */}
                        <ul style={styles.ul}>
                            ...
                            <ServiceItem><strong>Rounds:</strong>
                                <ul style={styles.nestedList}>
                                    <li>Four Rounds are conducted in the following manner
                                        <ul style={styles.nestedList}>
                                            <li>Assessment of online Aptitude Test:
                                                <ul style={styles.nestedList}>
                                            ...
                                            <li>Coding Test:
                                                <ul style={styles.nestedList}>
                                                    <li>2 questions with Difficulty Level - Easy to Medium with 30 minutes of time duration.</li>
                                                </ul>
                                            </li>
                                            <li>Values Assessment Test:
                                                <ul style={styles.nestedList}>
                                                    <li>It is a Scenario Based Test.</li>
                                                    <li>Shortlisted students of ‘Assessment of online Aptitude and Coding Test’ round will appear in this round.</li>
                                                </ul>
                                            </li>
                                            <li>Technical Interview:
                                                <ul style={styles.nestedList}>
                                                    <li>Students will be shortlisted based on the ‘Value Assessment Test’ and have to fill the candidate application form containing personal and professional details and then will be called for Interview.</li>
                                                    <li>Candidates shortlisted for the Interview have to appear for the interview physically with following original documents. [10th Result / 12th Result / Current Degree / Branch / Percentage]</li>
                                                </ul>
                                            </li>
                                            <li>HR Interview:
                                                <ul style={styles.nestedList}>
                        ...
                        <a href='HSBCprepare'><button className='btn btn-secondary' style={styles.button}>Start Preparation</button></a>
