        ...
        <div style={styles.contentContainer}>
          <div style={{ padding: "20px" }}>
            ...
            <h3 style={{ fontWeight: "bold", fontSize: "24px" }}>
              HSBC Syllabus For Aptitude Test
            </h3>{" "}
            {/* Updated heading */}
            <ul style={styles.ul}>
              <ServiceItem>
                The topics on which the <strong>HSBC Aptitude syllabus</strong>{" "}
                is based on are:
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        <a
                          href="https://youtu.be/TV9rQm15sWo?si=nWeoos8IpH51E56B"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtube.com/playlist?list=PLmzpgcvcqGjNd-LTey9FhgPUyP6ihtjzU&si=ceiyUjBNSIunLBcY"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/G-gqX4Oo9PA?si=Ujbr7PcVMSArDgRN"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/T2odvmxqi1I?si=7qvn05nXb9DhE2yB"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/jfoJBivWlnQ?si=oBO61w0oNpOyTqZH"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/xwqUyOT-cmU?si=E7uuxZRzzBHN5IQW"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/w-7mbazOx6o?si=8RjoSnGZDVx9EiSv"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/jvRq87ZWzIk?si=AMhQgDnhx1ZJ5l-S"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/uRA-QqVI3ec?si=2W8RmMEzFNvqE8Q0"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/OKSJDDAyqP0?si=okWAldTT3Wo6iHF0"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
              ...
              <ServiceItem>
                ...
                <strong>HSBC Verbal English syllabus</strong> is based on are:
                <ul style={{ ...styles.ul, marginLeft: "-10px" }}>
                  <ServiceItem>
                    Synonyms & Antonyms
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtube.com/playlist?list=PLRvmg8VHz-jUJPZKXQ4tMVq3hMVCdTGOo&si=1_mrNaetfhYfQFnH"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/8E4ha32ZVHU?si=txzbDy7uonxaSvEl"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/w8wkhKH2nXs?si=QGqCBol-c3BprIn5"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtube.com/playlist?list=PLBG_hRMQjgpwY4XPMGW72VB3VduRtzzWy&si=vu6wicAEvcpXdhON"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtube.com/playlist?list=PLpyc33gOcbVDBezm_qZaTe06k78oelATZ&si=68wa7kl_I29J-en3"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtube.com/playlist?list=PLou7ZkuAIPPuk0xVN_SuIhwYWczcMUvyW&si=vgjGL5QabbKGnhu-"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/xFGUTzBlAP8?si=8hwzznugVd8JN4s_"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
                  ...
                  <ServiceItem>
                    ...
                    <ul style={{ ...styles.ul, marginLeft: "20px" }}>
                      <li>
                        ...
                        -For referance, watch this video:{" "}
                        <a
                          href="https://youtu.be/w8wkhKH2nXs?si=W1fGlAX9f5VS261N"
                          target="_blank"
                          style={{ color: "red" }}
                        >
                          Watch Video
