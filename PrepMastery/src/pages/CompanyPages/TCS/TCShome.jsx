        ...
        <div style={styles.contentContainer}>
          <div style={{ padding: "20px" }}>
            ...
            <p style={{ marginTop: "10px" }}>
              ...
              business solutions firm that has been assisting many of the
              world's leading corporations in their transformation efforts for
              more than 50 years. It is based in Mumbai, Maharashtra, with its
              main campus in Chennai, Tamil Nadu. TCS is the world's largest IT
              services firm by market capitalization ($169.2 billion) as of
              February 2021.TCS is part of the Tata group, India's largest
              multinational corporate conglomerate, and employs approximately
              488,000 world-class consultants in 46 countries.
            </p>
            <p style={{ marginTop: "10px" }}>
              The Top Employers Institute has named TCS a Global Top Employer,
              one of just eight firms in the world to get this honor. TCS is
              able to attract and develop the greatest personnel by offering
              holistic long-term jobs based on continuous learning-enabled
            ...
            <p style={{ marginTop: "10px" }}>
              Established in 1968, TCS pioneered the IT industry back then and
              is globally the fastest growing IT services brand today. TCS has
              not only helped clients transform their businesses but has also
              reinvented itself well ahead of every technology wave over the
              past 50 years.
            </p>
            <h3
              style={{ fontWeight: "bold", fontSize: "24px", marginTop: "5px" }}
            ...
            <p style={{ marginTop: "10px" }}>
              JRD Tata along with Mr. Fakir chand Kohli also known as Father of
              Indian IT founded the TCS, initially started as Tata Computer
              Systems.
            </p>
            <h3
              style={{ fontWeight: "bold", fontSize: "24px", marginTop: "5px" }}
