...
const ServiceItem = ({ children }) => {
  ...
  const hasPadding =
    ...
    !childString.includes(
      "No Backlogs during the Tech Mahindra Recruitment Process."
    );
          ...
          <div style={{ padding: "20px" }}>
            ...
            <ul style={styles.ul}>
              ...
              <ServiceItem>
                ...
                <ul style={styles.nestedList}>
                  <li>
                    Five Rounds are conducted in the following manner
                    <ul style={styles.nestedList}>
                      <li>
                        Written Test:
                        <ul style={styles.nestedList}>
                          <li>
                            The first round in the Tech Mahindra Recruitment
                            Process is a written test to evaluate a candidate’s
                      ...
                      <li>
                        ...
                        <ul style={styles.nestedList}>
                          <li>
                            This round is a personality psychometric that is
                            used to assess work behaviour.{" "}
                          </li>
                        </ul>
                      </li>
                      <li>
                        ...
                        <ul style={styles.nestedList}>
                          <li>
                            In this round, they generally ask you to optimize
                            the codes you did in the second written round.
                          </li>
                        </ul>
                      </li>
                      <li>
                        ...
                        <ul style={styles.nestedList}>
                          <li>
                            This round will likely include questions about any
                            part of the candidate’s study. To pass this level,
                            you must have a strong understanding of computer
